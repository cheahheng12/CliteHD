...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener {
            ...
            when(it.itemId){
                R.id.nav_privacy -> {val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.clitehd.com/privacy/"))
                    startActivity(i)}
                R.id.nav_terms -> {
                    val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.clitehd.com/tnc.html"))
                    startActivity(i)
                }
                R.id.nav_setting -> {
                ...
                R.id.nav_getHelp -> {sendEmail(mail)}
            }
            true
        }
